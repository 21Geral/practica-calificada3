...
export default function Header() {
  ...
  return (
    <header className="w-full flex justify-around items-center p-4 bg-white/80 backdrop-blur-lg ">
      ...
      {mobileOpen && (
        <div className="fixed inset-0 bg-black/40 z-40" onClick={() => setMobileOpen(false)}>
          <div
            className="absolute top-0 right-0 h-full w-2/3 bg-white shadow-lg p-6 flex flex-col gap-6 text-gray-800"
